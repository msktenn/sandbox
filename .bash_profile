...
# Location of WebLogic install location
export WL_HOME=${HOME}/Oracle/Middleware/wls12130
export WL_PORT=7005

# Location of 4x domain
export DOMAIN_HOME=${WL_HOME}/user_projects/domains/fourxDomain

# Fully qualified domain for local service
export SERVICE_FQDN=local.onedatascan.io

# Hostname for local OpenAM access
export OPENAM_HOST=openam.local.onedatascan.io
export OPENAM_SERVER_URL=http://${OPENAM_HOST}:8080

# Location where OpenAM tools should be unzipped
