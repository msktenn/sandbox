...
namespace Restrike.GitHubIntegration.PostgresInstall
{
    ...
    public partial class DatabaseInstaller : Installer
    {
        ...
        public static void ShowHelp()
        {
            ...
            sb.AppendLine();
            sb.AppendLine("InstallUtil.exe Restrike.GitHubIntegration.PostgresInstall.dll [/connectionstring:connectionstring] [/transaction:true|false] [/skipnormalize] [/scriptfile:filename] [/scriptfileaction:append] [/checkonly] [/usehash] [/acceptwarnings:all|none|new|changed]");
            sb.AppendLine();
