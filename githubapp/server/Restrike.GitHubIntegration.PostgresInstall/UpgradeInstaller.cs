...
namespace Restrike.GitHubIntegration.PostgresInstall
{
    ...
    internal class UpgradeInstaller
    {
        ...
        internal const string DEFAULT_NAMESPACE = "Restrike.GitHubIntegration.PostgresInstall";
        internal const string MODELKEY = "708d9890-1cb1-4d50-be86-2f82697a5b95";
        private GeneratedVersion _previousVersion = null;
        private static GeneratedVersion _upgradeToVersion = new GeneratedVersion(0, 0, 0, 0, 1);
