...
namespace PortalGenerated
{
    ...
    class DeployDockerRepository
    {
        ...
        private static async Task<bool> EnsureResourceGroupExists(ResourceManagementClient resourceManagementClient, string resourceGroupName, string resourceGroupLocation)
        {
            ...
            if (exists)
            {
                ...
                var resourceGroup = new Microsoft.Azure.Management.ResourceManager.Fluent.ResourceGroup();
